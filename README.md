...
- `MATCHING.md` - matching engine internals, known title-mismatch patterns, manual review workflow.
...
tools. The public and admin surfaces are intentionally open with no Caddy auth.
